---
title: "Recording 4K60 on Linux: my first kernel patch, a USB quirk"
...
I needed this for my daughter Karolina's YouTube channel, [Karo's Gaming World](https://www.youtube.com/@KarosGamingWorld), which records clean 4K60 Nintendo gameplay. Shameless plug: if you like clean 4K60 Nintendo gameplay, leave her a sub. :)
...
The card hangs during enumeration at SuperSpeed Plus (10Gbps), drops to plain SuperSpeed (5Gbps), and re-attaches under a different product ID. SuperSpeed carries half the bandwidth, which caps the card at 4K30 instead of 4K60. Skipping the BOS request keeps it on the 10Gbps link, and 4K60 works on a mainline kernel with the in-tree driver.
...
The link trains at 10Gbps, the kernel asks for the BOS descriptor, the device stops responding, and after a few seconds of retries it gives up and re-attaches as `009c` at 5Gbps. That is plain SuperSpeed, half the bandwidth of SuperSpeed Plus, enough for 4K30 but not 4K60.
